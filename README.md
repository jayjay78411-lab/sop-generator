...
- `ollama_bridge.py` — `qwen2.5:2b-instruct` client (httpx with urllib fallback)
...
docker compose exec ollama ollama pull qwen2.5:2b-instruct
...
compose service (`qwen2.5:2b-instruct`).
